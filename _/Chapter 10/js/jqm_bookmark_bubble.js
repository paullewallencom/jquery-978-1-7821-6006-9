...
google.bookmarkbubble.Bubble.prototype.build_ = function() {
  ...
  bubble.className="googleInstallPromptBubble";
...
google.bookmarkbubble.Bubble.prototype.msg = {
  android: 
    '<strong>Please install this application </strong><br/>press and hold the bookmark after adding to save the bookmark press the Menu button, then select and save the "Add shortcut to Home"',
  android3: 
    '<img src="'+ google.bookmarkbubble.Bubble.prototype.IMAGE_ANDROID3_BOOKMARK_DATA_URL_ +'" style="height: 1.5em;display: inline-block;padding:0;margin:0;" /><strong>Please install this application </strong><br/>press and hold the bookmark after adding to save the bookmark press the Menu button, then select and save the "Add shortcut to Home"',
  android4: 
    '<img src="'+ google.bookmarkbubble.Bubble.prototype.IMAGE_ANDROID4_MOBILE_BOOKMARK_DATA_URL_ +'" style="height: 1.5em;display: inline-block;padding:0;margin:0;" /><strong>Please install this application </strong><br/>press and hold the bookmark after adding to save the bookmark press the Menu button, then select and save the "Add shortcut to Home"',
  blackberry: 
    '<strong>Install this app:</strong><br /> Tap <img src="'+ google.bookmarkbubble.Bubble.prototype.IMAGE_BLACKBERRY_ICON_DATA_URL_ +'" style="height: 1em;display: inline-block;padding:0;margin:0" />, select "<strong>Add to Home Screen</strong>"',
  playbook: 
     '<b>Install this app:</b><br /> Tap <img src="'+ google.bookmarkbubble.Bubble.prototype.IMAGE_PLAYBOOK_BOOKMARK_DATA_URL_ +'" style="height: 1.5em;display: inline-block;padding:0;margin:0;" />, select  <br />"<strong>Add to Home Screen</strong>"',
  ios42orlater :
     'Tap <img src="'+ google.bookmarkbubble.Bubble.prototype.IMAGE_SAFARI_FORWARD_DATA_URL_ +'" style="height: 1em;display: inline-block;padding: 0;margin: 0" />, then select <br/><strong>Add to Home Screen</strong> to install this application.',
  ioslegacy: 'Tap <strong style="font-size:15px">+</strong>, then select <strong>Add to Home Screen</strong> to install this application.'
};
